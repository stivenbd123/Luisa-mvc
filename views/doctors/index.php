...
<style>
    ...
    .badge-specialty { background-color: #e0e7ff; color: #4338ca; padding: 5px 10px; border-radius: 4px; font-size: 12px; font-weight: 600; border: 1px solid #c7d2fe; }
...
<div class="module-container">
    <div class="module-header">
        ...
        <a href="index.php?action=medicos_crear" class="btn-primary">Registrar Médico</a>
    </div>
        ...
        <tbody>
            ...
            <?php else: ?>
                <?php foreach($doctors as $doctor): ?>
                    <tr>
                        <td><?= $doctor['id'] ?></td>
                        <td><strong>Dr./Dra. <?= htmlspecialchars($doctor['name']) ?></strong></td>
                        <td>
                            <span class="badge-specialty">
                                <?= !empty($doctor['specialty_name']) ? htmlspecialchars($doctor['specialty_name']) : 'Sin asignar' ?>
                            </span>
                        </td>
                    </tr>
                <?php endforeach; ?>
