...
<div class="form-container">
    ...
    <form action="index.php?action=guardar_consultorio" method="POST">
        <div class="form-group">
            <label class="form-label">Identificador o Nombre de Sala</label>
            <input type="text" name="name" class="form-control" placeholder="Ej. Sala 101 - Pabellón A" required>
        </div>
        ...
        <div class="form-actions">
            <a href="index.php?action=consultorios" class="btn-cancel">Cancelar</a>
